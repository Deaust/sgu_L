...
<head>
    <title>Mantenimiento Vehiculos | IRCEP - Sistema de Gestión de Usuarios</title>
...
<body>
    ...
    <div id="layout-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Mantenimiento Vehiculos</h4>
        ...
        <?php require_once("modalasignardel.php"); ?>
        <?php require_once("modalasignarusu.php"); ?>
    </div>
    <?php require_once("../html/js.php"); ?>
    <script type="text/javascript" src="mntvehiculos.js"></script>
</body>
