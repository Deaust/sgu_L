...
<head>
    <title>Consultar Comprobaciones | IRCEP - Sistema de Gestión de Usuarios</title>
...
<body>
    ...
    <div id="layout-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Consultar Comprobaciones</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Menu</a></li>
                                        <li class="breadcrumb-item active">Comprobaciones</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                            ...
                            if ($c=== 1 ||$c=== 4){
                                ...
                                ?>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header align-items-center d-flex">
                                                <h5>Comprobaciones Personales</h5>
                                            </div>
                                            <div class="card-body">
                                                <table id="data_table_1" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                                    <thead>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                        <div class="card-header align-items-center d-flex">
                                                <h5>Comprobaciones Generales</h5>
                                            </div>
                                            <div class="card-body">
                                                <table id="data_table_4" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                                    <thead>
        ...
        <?php require_once("modaldetallecomp.php"); ?>
        <?php require_once("modalnuevacomp.php"); ?>
    </div>
    <?php require_once("../html/js.php"); ?>
    <script type="text/javascript" src="consultarcomprobaciones.js"></script>
</body>
