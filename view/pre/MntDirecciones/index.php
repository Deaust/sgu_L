...
<head>
    <title>Mnt. Direcciones | IRCEP - Sistema de Gestión de Usuarios</title>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Mantenimiento Direcciones</h4>
    ...
    <script type="text/javascript" src="mntdirecciones.js"></script>
</body>
