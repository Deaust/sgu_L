<?php
    ...
    $rol = new Rol();
    $datos = $rol->validar_acceso_2($_SESSION["USU_ID"],"areas");
...
<head>
    <title>Mnt. Delegaciones | IRCEP - Sistema de Gestión de Usuarios</title>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Mantenimiento Delegaciones</h4>
    ...
    <script type="text/javascript" src="mntdelegaciones.js"></script>
</body>
