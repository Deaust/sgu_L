            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="text-start ms-xl-2">
                            <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Usuario<!-- <?php echo $_SESSION["USU_NOM"]?> <?php echo $_SESSION["USU_APE"]?> --></span>
                        </span>
                        </span>
                    </button>

                    <!-- <input type="hidden" name="USU_IDx" id="USU_IDx" value="<?php echo $_SESSION["USU_ID"]?>"/>
                    <input type="hidden" name="ROL_IDx" id="ROL_IDx" value="<?php echo $_SESSION["ROL_ID"]?>"/> -->

                    <div class="dropdown-menu dropdown-menu-end">

                        <h6 class="dropdown-header">Bienvenid@ <!-- <?php echo $_SESSION["USU_NOM"]?> -->!</h6>
